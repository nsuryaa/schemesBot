...
// import schemesData from "./schemesData.json" assert { type: "json" };
  ...
  try {
    ...
    const options = {
      ...
      projection: {
        ...
        "scheme_details.beneficiaries": 1,
      },
    };
...
//   console.log(req.body);
//   const searchTerm = req.body.value.toLowerCase(); // Convert search term to lowercase for case-insensitive search
//   const scheme = schemesData.find((scheme) =>
//     scheme.scheme_details.title_name.toLowerCase().includes(searchTerm)
//   );
//   setSearchResult(scheme ? scheme.description : "Scheme not found");
// });
